PROGRAM cdfstrconv
  ...
  !!  $Id: cdfstrconv.f90 13 2007-02-24 21:15:22Z molines $
  !!--------------------------------------------------------------
  !!
  !! * Modules used
  USE cdfio 
  ...
  CHARACTER(LEN=80) :: cflux, ctau, csstr,csstrp, csstrn
  CHARACTER(LEN=80) :: coord='coordinates.diags'
  CHARACTER(LEN=80) :: cheader, cdum, config
  ...
  CHARACTER(LEN=80) :: cltextco
  LOGICAL :: lexist

  ! Netcdf Stuff
  CHARACTER(LEN=80) :: cemp, cqnet, cqsr, ctaux, ctauy, csst
